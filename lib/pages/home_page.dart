...
class _HomePageState extends State<HomePage> {
  ...
  void _saveFile(BuildContext context) async {
    if (_isValid) {
      final filePath =
          await FileHelper.getFilePath(filename: _titleController.text);
      FileHelper.writeFile(path: filePath, content: _contentController.text);
      if (mounted) {
        showCupertinoDialog(
          context: context,
          builder: (context) {
  ...
  void _openFile(String filePath) async {
    final content = await FileHelper.readFile(filePath: filePath);
